...
import com.redis.demo.day01.CacheWarmingService;
import com.redis.demo.day01.RedisDataStructureService;
import com.redis.demo.day01.SpringCacheService;
...
public class RedisDemoController {
    ...
    public ResponseEntity<Map<String, String>> demonstrateDataStructures() {
        redisDataStructureService.demonstrateStringOperations();
        redisDataStructureService.demonstrateHashOperations();
