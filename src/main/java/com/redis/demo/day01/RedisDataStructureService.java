...
public class RedisDataStructureService {
    ...
    public void demonstrateHashOperations() {
        ...
        // Map<String, Map<String, Object>> 형태
        // hash의 여러 필드에 저장
        ...
        log.info("업데이트 된 재고량: {}", updatedStock);
    }
    ...
    public void demonstrateListOperations() {
        ...
        List<Object> trimedList = redisTemplate.opsForList().range(key, 0, -1);
        log.info("잘린 리스트: {}", trimedList);
    }
    ...
    public void demonstrateSortedSetOperations() {
        ...
        log.info("점수가 100에서 200 사이인 제품: {}", productsRange);
