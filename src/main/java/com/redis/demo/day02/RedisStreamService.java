...
public class RedisStreamService {
    ...
    private void startStreamListenerContainerOptions() {
        ...
        Subscription inventorySubscription = listenerContainer.receive(
                ...
                new InventoryEventStreamListner()
        );
    ...
    private class OrderEventStreamListner implements StreamListener<String, MapRecord<String, String, String>> {
    ...
    private class InventoryEventStreamListner implements StreamListener<String, MapRecord<String, String, String>> {
